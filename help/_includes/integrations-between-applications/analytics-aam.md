...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>
                <a href="https://experienceleague.adobe.com/docs/analytics/integration/audience-analytics/mc-audiences-aam.html?lang=de" target="_blank" rel="noreferrer">Audience Manager sendet Daten zurück an [!DNL Analytics]</a>
            </td>
            <td>Tags-Erweiterung für Adobe [!DNL Analytics] oder AppMeasurement.js mit aktivierter Server-seitiger Weiterleitung</td>
            <td>
                <ul style="margin-top: 0;">
