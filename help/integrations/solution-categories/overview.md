...
Dieser Abschnitt hilft allen, die eine Geschäftsanforderung haben, ist aber nicht sicher, welche Adobe-Programme verwendet werden sollen und wie diese integriert werden sollen. Im Folgenden finden Sie die häufigsten Integrationskonfigurationen, die nach Lösungen organisiert sind (B2B-Marketing, Content supply chain, Dateneinblicke und Aktivierung usw.).

Beachten Sie, dass es je nach Umgebung viele Möglichkeiten gibt, die Adobe-Programme zu konfigurieren. In diesem Abschnitt erhalten Sie Anleitungen, die Sie unverändert bereitstellen oder an die Anforderungen Ihrer Umgebung anpassen können.
...
<tr>
   <td>
      <a  href="./content-supply-chain.md"><img alt="Content Supply chain" src="https://cdn.experienceleague.adobe.com/thumb/content-supply-chain.png?lang=de"/></a>
