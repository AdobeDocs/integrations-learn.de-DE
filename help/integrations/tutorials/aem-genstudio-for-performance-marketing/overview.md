...
Die Integration zwischen AEM Assets und GenStudio for Performance Marketing erfordert ein grundlegendes Verständnis folgender Punkte:

* Adobe GenStudio for Performance Marketing
* AEM Assets as a Cloud Service

Stellen Sie vor dem Einstieg in die Einrichtung und die Workflows sicher, dass Sie über den erforderlichen Zugriff auf AEM Assets und GenStudio for Performance Marketing verfügen.

## Erste Schritte

Lernen Sie zwei umfassende exemplarische Vorgehensweisen kennen, die Benutzern mit grundlegenden Kenntnissen von AEM Assets und GenStudio for Performance Marketing bereitgestellt wurden. Die erste exemplarische Vorgehensweise führt Sie durch den Einrichtungsprozess und deckt alles ab, was für die nahtlose Integration von Adobe GenStudio mit AEM Assets as a Cloud Service erforderlich ist. Der zweite Teil befasst sich mit wichtigen Workflows und zeigt die wichtigsten Konzepte zur Nutzung der Integration, um leistungsstarke Marketing-Inhalte effektiv zu erstellen, zu verwalten und zu verteilen.
...
Erfahren Sie mehr über praktische Anwendungsfälle, die für Benutzer mit grundlegenden Kenntnissen von AEM Assets und GenStudio for Performance Marketing entwickelt wurden. Diese Beispiele zeigen, wie diese Integration Ihre Workflows verbessert - indem Asset-Genehmigungsprozesse vereinfacht, benutzerdefinierte Inhaltsvarianten erstellt und verwendet und gezeigt wird, wie AEM Assets as a Cloud Service und GenStudio for Performance Marketing zusammenarbeiten, um effiziente und konsistente Performance-Marketing-Kampagnen zu ermöglichen.
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/integrations-learn/experience-cloud/tutorials/genstudio-for-performance-marketing-experience-manager/use-cases/use-case-1" title="Leichte Überprüfung und Genehmigung in Adobe GenStudio" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3439265/?format=jpeg&nocache=1733416518715" alt="Leichte Überprüfung und Genehmigung in Adobe GenStudio"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/integrations-learn/experience-cloud/tutorials/genstudio-for-performance-marketing-experience-manager/use-cases/use-case-2" title="Varianten mit Adobe GenStudio erstellen" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3439266/?format=jpeg&nocache=1733416518722" alt="Varianten mit Adobe GenStudio erstellen"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
