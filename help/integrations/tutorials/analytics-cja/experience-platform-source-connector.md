...
<ol>
    ...
    <li>Aufnehmen von Daten in Experience [!DNL Platform] mithilfe des <a href="https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics.html?lang=de" _target="_blank" rel="noopener noreferrer">Quell-Connectors für Adobe [!DNL Analytics]</a></li>
