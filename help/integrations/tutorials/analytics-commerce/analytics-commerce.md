...
Diese Anweisungen gelten für in Adobe [!DNL Commerce] Cloud gehostete Projekte. Selbst gehostet kann bis zu einem gewissen Grad variieren, aber der Gesamtprozess sollte ähnlich sein.
...
Sie können dies tun, indem Sie sich beim Administratorbereich von Adobe [!DNL Commerce] anmelden und nach diesen neuen Bereichen unter System > Dienste suchen
...
1. Konfigurieren Sie das -Modul mit Ihren -Anmeldeinformationen aus dem Adobe [!DNL Commerce]-Backoffice.
...
1. Erstellen oder aktualisieren Sie Ihr XDM-Schema mit [!DNL Commerce] Feldergruppen. Weiterführende Informationen zum Erstellen eines Schemas finden Sie im Tutorial [Erstellen von Schemas](https://experienceleague.adobe.com/docs/platform-learn/tutorials/schemas/create-schemas.html?lang=de) .
   ...
   * Nachdem Sie ein neues Schema erstellt haben, fügen Sie die [!DNL Commerce] Feldergruppen hinzu. Suchen Sie auf der linken Seite der Benutzeroberfläche nach Feldergruppen und klicken Sie auf **Hinzufügen**
      ...
      * Aktivieren Sie das Kontrollkästchen, um die **Adobe [!DNL Analytics] ExperienceEvent-[!DNL Commerce]** auszuwählen
...
1. Erstellen Sie den Datenstrom, um die [!DNL Commerce] Daten an Adobe zu senden[!DNL Analytics]
   ...
   * Klicken Sie **Service hinzufügen** und wählen Sie **Adobe-[!DNL Analytics]** in der Dropdown-Liste aus.
   ...
   * Wenn Sie in einem vorherigen Schritt einen Datensatz erstellt haben, klicken Sie optional erneut auf **Service hinzufügen** und wählen Sie **Adobe Experience[!DNL Platform]** aus der Dropdown-Liste aus. Wählen Sie im Feld Ereignis-Datensatz den zuvor erstellten Datensatz aus.
